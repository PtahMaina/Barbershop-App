<template>
  <div id="nav" class="fixed top-0 left-0 z-50 w-full " :class="{ 'text-white bgBlack md:h-16 h-0 md:p-2 p-0 md:transition-all md:duration-200 overflow-hidden md:overflow-auto ': scrollPosition > 100, active: isActive}" >
    <div class="flex flex-col mx-10 mt-32 md:mx-auto md:mt-0 md:grid md:items-center md:justify-center md:grid-cols-3 maxWidth ">
        <div class="justify-center hidden md:flex md:justify-start">
            <router-link class="flex items-center justify-center navbar-brand" to="/">
        ...
        <div class="flex flex-col items-start gap-10 no-underline md:grid md:grid-cols-4">
            <router-link @click="toggleNav" to="/" class="text-2xl font-semibold text-white no-underline md:text-base md:font-normal" >Home</router-link>
            <router-link @click="toggleNav" :to="{ name: 'Services'}" class="text-2xl font-semibold text-white no-underline md:text-base md:font-normal">Services</router-link>
            <router-link @click="toggleNav" :to="{ name: 'Story'}" class="text-2xl font-semibold text-white no-underline md:text-base md:font-normal">Story</router-link>
            <router-link @click="toggleNav" :to="{ name: 'Contact'}" class="text-2xl font-semibold text-white no-underline md:text-base md:font-normal">Contact Us</router-link>
            <router-link v-if="showAdmin" @click="toggleNav" :to="{ name: 'AdminDashBoard'}" class="text-2xl font-semibold text-white no-underline md:text-base md:font-normal">DashBoard</router-link>
        </div>
